...
void reuseLUT(int row, int col, hls::stream<data_type> out_stream[TM], hls::stream<data_type> in_stream[TM]);
...
#pragma HLS RESOURCE variable=input_data core=RAM_1P_LUTRAM
